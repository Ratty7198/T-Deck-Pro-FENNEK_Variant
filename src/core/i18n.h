...
#define FENNEK_STRS(X) \
  ...
  X(AppMesh,       "Mesh",           "Mesh",            "Mesh",           "MeshCore",            "Mesh") \
  ...
  X(TileMesh,      "Mesh",           "Mesh",            "Mesh",           "MeshCore",           "Mesh") \
  ...
  X(TileWeather,   "Wetter",         "Meteo",           "Väder",          "Weather",         "Clima") \
  X(TileWiFi,      "WiFi-Mon",       "Monit. WiFi",     "WiFi Spegla",    "WiFi-Mon",    "Monitor WiFi") \
  X(TileNodeMon,   "Knoten",         "Monit. Nodi",     "Nod Spegla",     "Node-Mon",    "Monitor Nodos") \
  ...
  X(MeshNoRadio,   "Radio nicht gefunden", "Radio non trovata", "Radion hittades inte", "LoRa not found", "Radio no encontrada") \
  ...
  X(SecRadio,      "Funk — wirkt sofort", "Radio — effetto immediato", "Radio — gäller direkt", "LoRa Settings", "Radio — efecto inmediato") \
  ...
  X(ChessThinking, "Fennek denkt ...","Fennek pensa ...","Fennek tänker ...", "Jarvis thinking ...", "Fennek piensa ...") \
  ...
  X(FmtChessWins,  "Siege gegen Fennek: %u", "Vittorie su Fennek: %u", "Segrar mot Fennek: %u", "Wins vs Jarvis: %u", "Victorias contra Fennek: %u") /* fmt: %u */ \
  /* --- Schach-Trainer --- */ \
  ...
  X(TttVsFennek,   "Gegner: Fennek", "Avversario: Fennek", "Motståndare: Fennek", "Opponent: Jarvis", "Rival: Fennek") \
